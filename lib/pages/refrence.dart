...
class HomePageRef extends StatefulWidget {
  HomePageRef({Key? key}) : super(key: key);

  @override
  State<HomePageRef> createState() => _HomePageRefState();
}

class _HomePageRefState extends State<HomePageRef> {
  @override
  void initState() {
    super.initState();
    // print(dataBase.myBox.isEmpty);
    fetchItem();
    getUserName();
  }
  ...
  getMyData(Map allData) {
    ...
    allData.forEach((key, value) {
      if (value['type'] == 'Income') {
        ...
        totalIcome += value['amount'] as int;
      } else {
        totalBalance -= value['amount'] as int;
  ...
  List<FlSpot> getSpot(Map mySpot) {
    spot = [];
    mySpot.forEach((key, value) {
  ...
  Widget transactType(int value, String type, String note, DateTime date) {
    return Container(
